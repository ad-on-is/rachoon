...
const getCountryCode = (country: string): string => {
  ...
  return countryData ? countryData.abbreviation : "";
};

const getCountry = (code: string): string => {
  const countryData = countries.find((c) => c.abbreviation === code);
  return countryData ? countryData.country : "";
};

export { Locale, countries, currencies, locales, getCountryCode, getCountry };
